...
<table class="table table-bordered table-primary table-hover border-primary">
    <tbody>
      <tr><th>Employee Name</th><td><?php echo htmlspecialchars($row['employee_name'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Employee Email</th><td><?php echo htmlspecialchars($row['employee_email'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Employee Phone Number</th><td><?php echo htmlspecialchars($row['employee_phone'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Employee Date of Birth</th><td><?php echo htmlspecialchars($row['dob'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Employee Details</th><td><?php echo htmlspecialchars($row['employee_details'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Employee Salary</th><td><?php echo htmlspecialchars($row['salary'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Created At</th><td><?php echo htmlspecialchars($row['created_at'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Updated At</th><td><?php echo htmlspecialchars($row['updated_at'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Last Login Time</th><td><?php echo htmlspecialchars($last, ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Status</th><td>Approved</td></tr>
      <tr><th>Skill</th><td><?php echo htmlspecialchars($row['skills'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Position</th><td><?php echo htmlspecialchars($position, ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>Department</th><td><?php echo htmlspecialchars($department, ENT_QUOTES, 'UTF-8'); ?></td></tr>
      <tr><th>User Type</th><td><?php echo htmlspecialchars($type, ENT_QUOTES, 'UTF-8'); ?></td></tr>
    </tbody>
</table>
<?php
} else {
